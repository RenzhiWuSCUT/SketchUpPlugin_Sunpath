module SuperCat
  module Sunpath
    ...
    unless file_loaded?(__FILE__) 
      ...
      cmd = UI::Command.new("Sunpath section") { Sketchup.active_model.select_tool SunpathSectionTool.new() }
      cmd.small_icon = "res/icon/sunpath_section.png"
      cmd.large_icon = "res/icon/sunpath_section.png"
      cmd.tooltip = "Sunpath section"
      cmd.status_bar_text = "Use this comment to generate the sunpath section."
      toolbar = toolbar.add_item(cmd)
